      ...
      <div className={`rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto shadow-2xl border ${
        ...
        <div className={`p-6 border-t flex gap-3 ${
          ...
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className="flex-1 px-4 py-2.5 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 disabled:opacity-50 text-white rounded-xl font-medium transition-all flex items-center justify-center gap-2"
          >
            {isLoading ? (
              <>
